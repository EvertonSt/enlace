...
export const MOCK_INVOICE: Invoice = {
  ...
  status: 'pending',
  lineItems: [
    { description: 'Fibra Premium 300 Mbps — Agosto 2026', amount: 119.9 },
  ],
...
export const MOCK_TICKETS: Ticket[] = [
  {
    ...
    aiTriage: {
      ...
      provider: 'claude',
      triagedAt: '2026-08-18T19:31:00Z',
  ...
  },
  {
    ...
    aiTriage: {
      ...
      provider: 'claude',
      triagedAt: '2026-08-20T08:15:30Z',
      model: 'claude-sonnet-4-20250514',
      confidence: 0.97,
    },
...
export const MOCK_OUTAGES: OutageEvent[] = [
  {
    ...
    startedAt: '2026-08-22T03:15:00Z',
    estimatedResolution: '2026-08-22T12:00:00Z',
    resolvedAt: null,
